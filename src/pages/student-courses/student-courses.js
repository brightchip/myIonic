...
var StudentCoursesPage = (function () {
    function StudentCoursesPage(navCtrl, navParams, confData, config, inAppBrowser, userData) {
    ...
    StudentCoursesPage.prototype.gotoCourse = function (promo) {
        console.log("gotoCourse", promo);
        this.navCtrl.push(home_1.HomePage, { title: promo.title });
    };
...
exports.StudentCoursesPage = StudentCoursesPage;
